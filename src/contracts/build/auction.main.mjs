...
export async function Seller(ctcTop, interact) {
  ...
  const txn2 = await (ctc.sendrecv({
    ...
    sim_p: (async (txn2) => {
      ...
      const v756 = await (async () => {
        sim_r.txns.push({
          ...
          remote: ({
            accs: [],
            apps: [],
            bills: stdlib.checkedBigNumberify('./src/contracts/auction.rsh:105:39:application', stdlib.UInt_max, '0'),
            fees: stdlib.checkedBigNumberify('<builtin>', stdlib.UInt_max, '0'),
            pays: stdlib.checkedBigNumberify('./src/contracts/auction.rsh:105:39:application', stdlib.UInt_max, '0'),
            toks: []
            })
          })
      ...
      const v759 = v757[stdlib.checkedBigNumberify('./src/contracts/auction.rsh:105:39:application', stdlib.UInt_max, '0')];
  ...
  stdlib.assert(v765, {
    at: './src/contracts/auction.rsh:105:39:application',
    fs: [],
    msg: 'remote bill check',
    who: 'Seller'
    });
