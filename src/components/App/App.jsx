	...
	return (
		<div className={cf(s.wMax)}>
			...
			>
				...
				>
					<h2 className={cf(s.wMax, s.p0, s.m0, app.heroWelcomeText)}>
						Welcome to Auctoken
					</h2>
				</div>
				<div
			...
			>
				<div className={cf(app.forestTextCon)}>
					<h2 className={cf(app.forestText)}>Start trading.</h2>
				</div>
				<div
					className={cf(
						s.wMax,
			...
			>
				...
				>
					...
					>
						...
						<div className={app.comSocialContent}>
							<div className={app.comSocialName}>The Platform</div>
							<div className={app.comSocialDescription}>
								<span
									className={cf(s.wMax, s.dInlineBlock, app.comSocialDesText)}
								>
