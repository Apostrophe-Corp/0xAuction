...
export const main = Reach.App(() => {
 ...
 // check that pay is succesful and add event to inform start of auction

 const [keepGoing, highestBidder, lastPrice, isFirstBid] = parallelReduce([true, Seller, 0, true])
 ...
 .api(Sellers.stopAuction, (notify) => {
